...
class Emitter():
    ...
    def getJVMType(self, inType):
        ...
        if typeIn is IntType:
            ...
            return "V"
        elif typeIn in [ArrayPointerType,ArrayType]:
    ...
    *    @param typ the type of the constant
    ...
    def emitALOAD(self, in_, frame):
        ...
        elif type(in_) in (ArrayPointerType, cgen.ClassType, StringType):
    ...
    *   @param toLabel the ending label  of the scope where the variable is active.
    ...
    def emitVAR(self, in_, varName, inType, fromLabel, toLabel, frame):
        ...
        #fromLabel: Int
        #toLabel: Int
        #frame: Frame   not changed after calling this method
        code = self.jvm.emitVAR(in_, varName, self.getJVMType(inType), fromLabel, toLabel)
        if isinstance(inType, ArrayType):
    ...
    def emitREADVAR(self, name, inType, index, frame):
        ...
        elif type(inType) in (ArrayType, ArrayPointerType,cgen.ClassType,StringType):
